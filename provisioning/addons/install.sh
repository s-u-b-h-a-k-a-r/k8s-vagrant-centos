...
figlet NFS-CLIENT
su - vagrant -c "helm install stable/nfs-client-provisioner --name nfs-client-provisioner --set nfs.server=$1 --set nfs.path=/mnt/storage --set storageClass.defaultClass=false"